...
function toggleTheme() {
    ...
    checkbox.addEventListener("change", function () {
        if (checkbox.checked) {
            ...
            ContainerFirst.style.backgroundImage = "linear-gradient(to right bottom ,#22272d,#00303d,#232323)";
            leftBlue.style.backgroundImage = "linear-gradient(to right, #272c36,#575757)";
            ...
            forthright.style.backgroundImage = "linear-gradient(to right bottom ,#22272d,#00303d,#232323)";
            ...
            ContainerFirst.style.backgroundImage = "linear-gradient(to right bottom ,#22272d,#00b4d8,#0077b6)";
            leftBlue.style.backgroundImage = "linear-gradient(to right, #3dd5f3,#3dd5f397)";
            scrollTexth1.style.Color = "#4950576e";
            scrollTexth1.style.opacity = 0.1;
            rightYellow.style.boxShadow = "-5px 5px 20px 5px #2a474d74,5px 5px 20px 5px #fcc22f8e";
...
let HideNavBar = document.querySelector(".Hide-NavBar");
...
menuIcon.addEventListener("click", function () {
    ...
    arrow.addEventListener("click", function (e) {
        parentOfarrow = e.target.parentElement;
...
function customerReviewSlider() {
    ...
    function showCustomPrev() {
      customCurrentIndex = (customCurrentIndex - 1 + customSlideItems.length) % customSlideItems.length;
      updateCustomSlider();
    }
